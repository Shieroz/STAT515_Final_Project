...
### Interpretation: The data satisfy ANOVA assumption so the testing is reliable. Since there have no significant different betwen in average interest_rate for each state.
